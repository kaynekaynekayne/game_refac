...
// export const SEARCH_URL=(game_name)=>`${BASE_URL}games?key=${process.env.REACT_APP_KEY}&search=${game_name}`

export const GENRE_URL=()=>`${BASE_URL}genres?key=${process.env.REACT_APP_KEY}`;
