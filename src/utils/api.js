...
export const GAME_POP_URL=()=>`${BASE_URL}?key=${process.env.REACT_APP_KEY}${populars}`;
export const GAME_UP_URL=()=>`${BASE_URL}?key=${process.env.REACT_APP_KEY}${upcomings}`;
export const GAME_NEW_URL=()=>`${BASE_URL}?key=${process.env.REACT_APP_KEY}${news}`;
